    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 text-white p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-3 mb-auto">
          <div className="bg-white p-1 rounded-xl shadow-lg shadow-indigo-500/30 flex items-center justify-center w-12 h-12">
            <img src="/logo.png" alt="Mamannar Logo" className="w-full h-full object-contain" />
          </div>
          <div>
            <span className="text-xl font-bold tracking-tight">Mamannar</span>
            <span className="ml-2 text-xs bg-indigo-500/30 text-indigo-300 px-2 py-0.5 rounded-full font-medium">Hotel</span>
          </div>
        </div>
        ...
        <p className="relative z-10 text-xs text-slate-600 mt-8">
          © {new Date().getFullYear()} Mamannar Hotel. All rights reserved.
        </p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center bg-background px-6 py-12 overflow-y-auto">
        <div className="w-full max-w-md py-10">
          ...
          <div className="flex lg:hidden items-center gap-2 mb-10">
            <div className="bg-white p-1 rounded-xl shadow-lg shadow-primary/30 flex items-center justify-center w-10 h-10">
              <img src="/logo.png" alt="Mamannar Logo" className="w-full h-full object-contain" />
            </div>
            <span className="text-xl font-bold text-foreground tracking-tight">Mamannar Hotel</span>
          </div>
          ...
          {registerSuccess ? (
            <div className="text-center">
              ...
              <h2 className="text-2xl font-extrabold text-foreground tracking-tight">Request Received!</h2>
              <p className="mt-3 text-muted-foreground leading-relaxed">
                Thank you for your interest in Mamannar Hotel. Our team has received your details and will call you shortly to process your setup and email you the access token.
              </p>
              <button
            ...
            <>
              <div className="mb-8">
                <div className="flex items-center justify-center w-12 h-12 rounded-2xl bg-primary/10 border border-primary/20 mb-6">
                  <UserPlus className="h-5 w-5 text-primary" />
                </div>
                <h2 className="text-2xl font-extrabold text-foreground tracking-tight">Request Access</h2>
                <p className="mt-1.5 text-sm text-muted-foreground">Register your business to get a license key.</p>
              </div>
              ...
              <p className="mt-6 text-center text-sm text-muted-foreground">
                ...
                <button onClick={() => setIsRegistering(false)} className="text-primary font-semibold hover:underline">
                  Sign in
                </button>
              </p>
            </>
            ...
            <>
              ...
              <p className="mt-8 text-center text-sm text-muted-foreground">
                New business?{" "}
                <button onClick={() => setIsRegistering(true)} className="text-primary font-semibold hover:underline">
                  Request access
                </button>
              </p>
            </>
